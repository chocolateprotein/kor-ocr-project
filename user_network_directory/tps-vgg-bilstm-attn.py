...
class Model(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, hidden_size, num_class,imgH, imgW, num_fiducial):
    ...
    def forward(self, input, text):
        ...
        """ Prediction stage """
        prediction = self.Prediction(contextual_feature.contiguous(), text,  batch_max_length=self.batch_max_length)
...
class Attention(nn.Module):
    ...
    def forward(self, batch_H, batch_max_length=25,):
        """
        input:
